...
public class ConvTaskDeta extends AbstractEntity {
	...
	@Id	@GeneratedValue(strategy = GenerationType.AUTO)	@Column(name = "DETA_ID")	@JsonProperty
	private long id;                  // 협약과제상세T_아이디
	
	@OneToOne	@JoinColumn(name = "TASK_ID")
	...
	@Builder
	public ConvTaskDeta(ConvTask convTask,
			String convInstCd,
			String convTaskNum,
			String bimokGrouBizNm,
			String bizClasCd,
			String techFielCd,
			String totaRechStDd,
			String totaRechEdDd,
			...
			int inteStuf,
			String reseRequBkCd,
			String reseRequAccNum,
			String reseRequAccHold,
			String reseCardBkCd,
			String reseCardPaymAccNum,
			String reseCardPaymAccHold,
			String rechInstBizRegiNum,
			String rechInstGrouCd,
